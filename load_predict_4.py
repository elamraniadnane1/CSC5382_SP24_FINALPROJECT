...
def main():
    ...
    with mlflow.start_run():
        ...
        # Consider adding GPU/CPU specs, and libraries versions
        ...
        # Experiment Tags
        mlflow.set_tag("experiment_type", "Sentiment Analysis")
        mlflow.set_tag("model_framework", "Transformers")

        # Data Preprocessing and Model Configuration (if any)
        # mlflow.log_param("preprocessing_details", "your_preprocessing_details")
        # mlflow.log_param("model_hyperparameters", "your_model_hyperparameters")
        ...
        model_name = "Election2024StancePredictionModel"
        ...
        # Evaluation Metrics and Artifacts (if applicable)
        # mlflow.log_artifact("path_to_evaluation_metrics")
        # mlflow.log_artifact("path_to_confusion_matrix")
