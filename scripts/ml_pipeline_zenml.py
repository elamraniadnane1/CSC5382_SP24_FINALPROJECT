...
@step
def prepare_data_step(tokenized_data: dict) -> Annotated[Output[dict], step("Prepare Data")]:
    """
    ZenML step to prepare data.
    ...
    Returns:
        dict: Prepared data.
    """
    # Prepare data using the prepare_data function from scripts.prepare_data
    prepared_data = prepare_data(tokenized_data)
...
@step
def train_model_step(train_data: dict) -> Annotated[Output[object], step("Train Model")]:
    """
    ...
    """
    # Train model using the train_model function from scripts.train_model
    model = train_model(train_data)
    return model

@step
def evaluate_model_step(model: object, eval_data: dict) -> Annotated[Output[dict], step("Evaluate Model")]:
    """
    ...
    """
    # Evaluate model using the evaluate_model function from scripts.evaluate_model
    evaluation_metrics = evaluate_model(model, eval_data)
    return evaluation_metrics



@step
def save_model_step(model: object) -> Annotated[Output[str], step("Save Model")]:
    """
    ...
    """
    # Save model using the save_model function from scripts.save_model
