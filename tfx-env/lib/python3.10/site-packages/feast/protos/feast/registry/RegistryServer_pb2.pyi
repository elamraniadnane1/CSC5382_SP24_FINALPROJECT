...
class GetRequestFeatureViewRequest(google.protobuf.message.Message):
    """RequestFeatureView
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_cache",b"allow_cache","name",b"name","project",b"project"]) -> None: ...
global___GetRequestFeatureViewRequest = GetRequestFeatureViewRequest

class ListRequestFeatureViewsRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PROJECT_FIELD_NUMBER: builtins.int
    ALLOW_CACHE_FIELD_NUMBER: builtins.int
    project: typing.Text = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_cache",b"allow_cache","project",b"project"]) -> None: ...
global___ListRequestFeatureViewsRequest = ListRequestFeatureViewsRequest

class ListRequestFeatureViewsResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["request_feature_views",b"request_feature_views"]) -> None: ...
global___ListRequestFeatureViewsResponse = ListRequestFeatureViewsResponse
