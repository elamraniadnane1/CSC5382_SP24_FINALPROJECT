...
class RegistryServer(object):
    ...
    def GetRequestFeatureView(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/feast.registry.RegistryServer/GetRequestFeatureView',
    ...
    def ListRequestFeatureViews(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/feast.registry.RegistryServer/ListRequestFeatureViews',
